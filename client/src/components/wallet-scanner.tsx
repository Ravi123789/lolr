...
export function WalletScanner() {
  ...
  return (
    <>
      <section className="py-4 md:py-6 animate-fade-in lg:px-0">
        <div className="clay-card desktop-trust-scanner-card p-3 md:p-4 lg:p-6 mb-3 md:mb-4 relative overflow-hidden w-full lg:mx-4 xl:mx-8">
