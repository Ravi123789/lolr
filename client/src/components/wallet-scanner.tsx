  ...
  return (
    <>
      <section className="py-2 md:py-3 animate-fade-in">
        <div className="clay-card p-2 md:p-3 lg:p-3 mb-2 md:mb-3 relative overflow-hidden w-full max-w-lg md:max-w-md lg:max-w-2xl xl:max-w-3xl 2xl:max-w-4xl mx-auto">
